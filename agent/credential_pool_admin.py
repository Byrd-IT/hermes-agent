...
class CredentialPoolAdminMixin:
    ...
    def move_entry(self, credential_id: str, priority: int) -> Optional[PooledCredential]:
        ...
        from agent.credential_pool import _coerce_credential_priority, _normalize_pool_priorities
        ...
        with self._lock:
            ...
            self._entries = sorted(entries, key=lambda e: _coerce_credential_priority(e.priority))
            self._persist()
