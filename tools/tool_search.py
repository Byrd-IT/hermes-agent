        ...
        _bridge_schema(
            ...
            "Policy, hooks, and approvals run as for directly-listed tools.",
            {
                "calls": {
                    ...
                    "description": "Exactly ONE entry when invoking a local tool (mcp__*, or any name without the connectors__ prefix); one or more entries only when every entry is a connectors__ tool. Never mix local and connector tools.",
                },
            },
            ["calls"],
        ),
